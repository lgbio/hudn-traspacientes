"""
Configuración de la aplicación app_traslados.
"""
...
class AppTrasladosConfig (AppConfig):
	...
	def ready (self):
		...
		import app_traslados.models  # noqa: F401 — registra señales post_save
		...
		def inicializarMeses (sender, **kwargs):
			...
			ControlMes = apps.get_model ('app_traslados', 'ControlMes')
